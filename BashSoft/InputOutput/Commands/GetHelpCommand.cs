...
namespace BashSoft.InputOutput.Commands
{
    class GetHelpCommand : Command
    {
        ...
        private void DisplayHelp()
        {
            ...
            OutputWriter.WriteMessageOnNewLine(string.Format("|{0, -98}|", "make directory - mkdir {folder name} "));
            OutputWriter.WriteMessageOnNewLine(string.Format("|{0, -98}|", "delete directory - deldir {folder name}  "));
